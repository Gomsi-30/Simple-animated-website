       ...
       <div className='bg-gradient-to-r from-purple-200 via-blue-200 to-pink-300 h-screen p-8 overflow:hidden'>
          <div className='h-[88vh] border-4 border-black rounded-[30px] overflow-hidden'>
             ...
             <div className='hidden md:flex flex-col gap-6 justify-center '>
                   ...
                   <div className='flex flex-col gap-1 text-3xl font-bold w-[270px] text-with-border'>
                   ...
                   <a href="https://www.xenotix.co.in/" className='text-center signup3 signupXL3 signupLG3 signupMD3 p-1 bg-black text-white w-[100px] rounded-[11px]' target="_blank" rel="noopener noreferrer">Explore Us</a>

                </div>
                <div className='relative md:mt-[-280px] xs:mt-[50px] z-20 '>
                   <div className='xs:hidden box box1 boxXL1 boxLG1 leftyrighty sm:top-40 sm:left-[-150px] md:top-0 md:left-0 absolute sm:h-[120px] sm:w-[120px] md:block xl:h-[230px] xl:w-[230px]  bg-red-300 md:rotate-[30deg]'>
                     <img src='https://images.pexels.com/photos/383557/pexels-photo-383557.jpeg?auto=compress&cs=tinysrgb&w=600'
                     className='h-full w-full object-cover' /> 
                   </div>
                   <div className=' xs:hidden md:block box box2 boxXL2 boxLG2 leftydowny absolute sm:top-0 sm:left-[-150px] md:top-0 md:left-0 sm:h-[120px] sm:w-[120px] xl:h-[230px] xl:w-[230px] bg-pink-100 md:rotate-[20deg]'>
                    <img src='https://images.pexels.com/photos/4001296/pexels-photo-4001296.jpeg?auto=compress&cs=tinysrgb&w=600' 
                    className='h-full w-full object-cover' /> 
                   </div>
                   <div className='box box3 boxXL3 boxLG3 rightylefty absolute xs:top-0 xs:left-[0px] md:top-0 md:left-0 xs:h-[120px] xs:w-[120px] xl:h-[230px] xl:w-[230px] bg-blue-100 md:rotate-[10deg]'>
                   <img src='https://images.pexels.com/photos/255387/pexels-photo-255387.jpeg?auto=compress&cs=tinysrgb&w=600'  
                   className='h-full w-full object-cover' />
                   </div>
                   <div className='box box4 boxXL4 boxLG4 rightydowny xs:top-0 xs:left-[200px] md:top-0 md:left-0 absolute xs:h-[120px] xs:w-[120px] xl:h-[230px] xl:w-[230px]  bg-yellow-100 md:rotate-[0deg]'>
                     <img 
                ...
                <div className='hidden md:block md:relative mt-[-280px] ml-[450px]'>
                   ...
                   <div className='boxy boxy1 boxyXL1 boxyLG1 md:absolute sm:h-[120px] sm:w-[120px] xl:h-[230px] xl:w-[230px]  bg-blue-100' style={{transform:'rotate(10deg)'}}>
                   <img src='https://images.pexels.com/photos/255387/pexels-photo-255387.jpeg?auto=compress&cs=tinysrgb&w=600'  
                   style={{ height: '100%', width: '100%', objectFit: 'cover' }}  />
                   </div>
                   <div className='boxy boxy2 boxyXL2 boxyLG2 md:absolute sm:h-[120px] sm:w-[120px] xl:h-[230px] xl:w-[230px]  bg-yellow-100' style={{transform:'rotate(0deg)'}}>
                     <img 
                         src='https://images.pexels.com/photos/4001296/pexels-photo-4001296.jpeg?auto=compress&cs=tinysrgb&w=600' 
                         style={{ height: '100%', width: '100%', objectFit: 'cover' }} 
                     />
