    ...
    return (
       ...
       <div className='bg-gradient-to-r from-purple-200 via-blue-200 to-pink-300 h-screen p-12 overflow:hidden'>
          <div className='h-[88vh] border-4 border-black rounded-[30px] overflow-hidden'>
             <nav className='flex flex-row justify-between p-7 md:px-[90px] lg:px-[150px]'>
             ...
             <nav className='flex flex-row justify-between items-center p-3 md:px-[87px] lg:px-[150px] relative'>
                ...
                <div className='hidden1 absolute top-[30px] left-[460px] flex flex-col justify-center items-center rounded-full h-[200px] w-[200px] bg-gradient-to-r from-rose-100 via-purple-100 to-pink-200'>
             ...
             <div className='md:px-[100px] lg:px-[230px] flex flex-row md:gap-[10px] md:justify-around lg:gap-[380px] mt-[60px] items-center overflow:hidden'>
                ...
                <div className='relative mt-[-280px] z-20'>
                   <div className='box box1 boxXL1 boxLG1 absolute xl:h-[250px] xl:w-[250px] 2xl:h-[310px] 2xl:w-[310px] bg-red-300' style={{transform:'rotate(30deg)'}}>
                     <img src='https://images.pexels.com/photos/383557/pexels-photo-383557.jpeg?auto=compress&cs=tinysrgb&w=600'
                     style={{ height: '100%', width: '100%', objectFit: 'cover' }}  /> 
                   </div>
                   <div className='box box2 boxXL2 boxLG2 absolute xl:h-[250px] xl:w-[250px] 2xl:h-[310px] 2xl:w-[310px] bg-pink-100' style={{transform:'rotate(20deg)'}}>
                    <img src='https://images.pexels.com/photos/4001296/pexels-photo-4001296.jpeg?auto=compress&cs=tinysrgb&w=600' 
                    style={{ height: '100%', width: '100%', objectFit: 'cover' }}  /> 
                   </div>
                   <div className='box box3 boxXL3 boxLG3 absolute xl:h-[250px] xl:w-[250px] 2xl:h-[310px] 2xl:w-[310px] bg-blue-100' style={{transform:'rotate(10deg)'}}>
                   <img src='https://images.pexels.com/photos/255387/pexels-photo-255387.jpeg?auto=compress&cs=tinysrgb&w=600'  
                   style={{ height: '100%', width: '100%', objectFit: 'cover' }}  />
                   </div>
                   <div className='box box4 boxXL4 boxLG4 absolute xl:h-[250px] xl:w-[250px] 2xl:h-[310px] 2xl:w-[310px] bg-yellow-100' style={{transform:'rotate(0deg)'}}>
                     <img 
                ...
                {/*  */}
                <div className='relative mt-[-280px] ml-[450px]'>
                   
                   <div className='boxy boxy1 boxyXL1 boxyLG1 absolute xl:h-[250px] xl:w-[250px] 2xl:h-[310px] 2xl:w-[310px] bg-blue-100' style={{transform:'rotate(10deg)'}}>
                   <img src='https://images.pexels.com/photos/255387/pexels-photo-255387.jpeg?auto=compress&cs=tinysrgb&w=600'  
                   style={{ height: '100%', width: '100%', objectFit: 'cover' }}  />
                   </div>
                   <div className='boxy boxy2 boxyXL2 boxyLG2 absolute xl:h-[250px] xl:w-[250px] 2xl:h-[310px] 2xl:w-[310px] bg-yellow-100' style={{transform:'rotate(0deg)'}}>
                     <img 
                         src='https://images.pexels.com/photos/4001296/pexels-photo-4001296.jpeg?auto=compress&cs=tinysrgb&w=600' 
                         style={{ height: '100%', width: '100%', objectFit: 'cover' }} 
                     />
